...
src_install() {
	...
	doins OvmfX64/RELEASE_GCC5/FV/OVMF.fd || die "Cannot install OVMF!"
	doins OvmfX64/RELEASE_GCC5/FV/OVMF_VARS.fd || die "Cannot install OVMF!"
	# Install JSON for QEMU
	dodir /usr/share/qemu/firmware
	insinto /usr/share/qemu/firmware
	doins ${FILESDIR}/20-edk2-ovmf-x64-schmidicom.json || die "Cannot install JSON for QEMU!"
}
