...
src_install() {
	...
	doins OvmfX64/RELEASE_GCC5/FV/OVMF_VARS.fd || die "Cannot install OVMF_VARS with empty Certstore!"
	doins ${FILESDIR}/OVMF_VARS_sb-enabled.fd || die "Cannot install OVMF_VARS with SB Enabled!"
